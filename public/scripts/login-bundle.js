// [AIV_SHORT]  Build version: 0.0.6 - Saturday, April 28th, 2018, 10:52:00 PM  
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _cookies = __webpack_require__(/*! ./cookies */ \"./client/login/cookies.js\");\n\nvar _cookies2 = _interopRequireDefault(_cookies);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Account = function () {\n    function Account(api) {\n        _classCallCheck(this, Account);\n\n        this.api = api;\n        this.isDisclaimerSeen = _cookies2.default.get('isDisclaimerSeen');\n        this.sessionKey = _cookies2.default.get('session');\n        this.username = _cookies2.default.get('username');\n    }\n\n    _createClass(Account, [{\n        key: 'login',\n        value: function () {\n            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(username, password, isRememberMe) {\n                var message;\n                return regeneratorRuntime.wrap(function _callee$(_context) {\n                    while (1) {\n                        switch (_context.prev = _context.next) {\n                            case 0:\n                                _context.prev = 0;\n                                _context.next = 3;\n                                return this.api.login(username, password);\n\n                            case 3:\n                                this.sessionKey = _context.sent;\n\n                                this.username = isRememberMe ? username : '';\n\n                                _cookies2.default.setForever('username', this.username);\n                                _cookies2.default.setUntilBrowserClose('session', this.sessionKey);\n                                _context.next = 23;\n                                break;\n\n                            case 9:\n                                _context.prev = 9;\n                                _context.t0 = _context['catch'](0);\n                                message = void 0;\n\n                                if (!_context.t0.httpStatusCode) {\n                                    _context.next = 22;\n                                    break;\n                                }\n\n                                _context.t1 = _context.t0.httpStatusCode;\n                                _context.next = _context.t1 === 400 ? 16 : _context.t1 === 401 ? 16 : _context.t1 === 500 ? 18 : 20;\n                                break;\n\n                            case 16:\n                                // Unauthorised\n                                message = 'Username or password incorrect.';\n                                return _context.abrupt('break', 22);\n\n                            case 18:\n                                message = 'Something went wrong on the server.';\n                                return _context.abrupt('break', 22);\n\n                            case 20:\n                                message = 'Something went wrong outside of our control.';\n                                return _context.abrupt('break', 22);\n\n                            case 22:\n                                throw Error(message);\n\n                            case 23:\n                            case 'end':\n                                return _context.stop();\n                        }\n                    }\n                }, _callee, this, [[0, 9]]);\n            }));\n\n            function login(_x, _x2, _x3) {\n                return _ref.apply(this, arguments);\n            }\n\n            return login;\n        }()\n    }, {\n        key: 'logout',\n        value: function logout() {\n            this.sessionKey = null;\n            _cookies2.default.setUntilBrowserClose('session', '');\n        }\n    }]);\n\n    return Account;\n}();\n\nexports.default = Account;\n\n//# sourceURL=webpack:///./client/login/account.js?");

/***/ }),

/***/ "./client/login/cookies.js":
/*!*********************************!*\
  !*** ./client/login/cookies.js ***!
  \*********************************/
/*! no static exports found */
...
/***/ 0:
/*!**********************************************!*\
  !*** multi babel-polyfill ./client/login.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! babel-polyfill */\"./node_modules/babel-polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! ./client/login.js */\"./client/login.js\");\n\n\n//# sourceURL=webpack:///multi_babel-polyfill_./client/login.js?");
